...
public class placerwe implements Listener {
    public placerwe(Block bed1, TeamColor col1, int i, IArena ar1) {
        ...
        double woolcolor = 0;
        if (col1.name().equals("RED")) {
            woolcolor = 14;
        } else if (col1.name().equals("BLUE")) {
            woolcolor = 11;
        } else if (col1.name().equals("GREEN")) {
            woolcolor = 5;
        } else if (col1.name().equals("YELLOW")) {
            woolcolor = 4;
        } else if (col1.name().equals("AQUA")) {
            woolcolor = 3;
        } else if (col1.name().equals("WHITE")) {
            woolcolor = 0;
        } else if (col1.name().equals("PINK")) {
            woolcolor = 6;
        } else if (col1.name().equals("GRAY")) {
            woolcolor = 8;
        } else if (col1.name().equals("DARK_GREEN")) {
            woolcolor = 13;
        } else if (col1.name().equals("DARK_GRAY")) {
            woolcolor = 7;
        }
        ...
        bed1.getWorld().getBlockAt(AXXX, TOY, TOZ).setData((byte) woolcolor);
        ...
        bed1.getWorld().getBlockAt(BXXX, TOY, BZZZ).setData((byte) woolcolor);
        ...
        bed1.getWorld().getBlockAt(XXXX, TOY, ZZZZ).setData((byte) woolcolor);
        ...
        bed1.getWorld().getBlockAt(CXXX, TOY, CZZZ).setData((byte) woolcolor);
        ...
        bed1.getWorld().getBlockAt(DXXX, TOY, DZZZ).setData((byte) woolcolor);
        ...
        bed1.getWorld().getBlockAt(EXXX, TOY, EZZZ).setData((byte) woolcolor);
        ...
        bed1.getWorld().getBlockAt(FXXX, TOY, FZZZ).setData((byte) woolcolor);
        ...
        bed1.getWorld().getBlockAt(GXXX, TOY, GZZZ).setData((byte) woolcolor);
        ...
        bed1.getWorld().getBlockAt(HXXX, TOY, HZZZ).setData((byte) woolcolor);
        ...
        bed1.getWorld().getBlockAt(IXXX, TOY, IZZZ).setData((byte) woolcolor);
        ...
        bed1.getWorld().getBlockAt(JXXX, TOY, JZZZ).setData((byte) woolcolor);
        ...
        bed1.getWorld().getBlockAt(KXXX, TOY, KZZZ).setData((byte) woolcolor);
        ...
        bed1.getWorld().getBlockAt(LXXX, TOY, LZZZ).setData((byte) woolcolor);
        ...
        bed1.getWorld().getBlockAt(MXXX, TOY, MZZZ).setData((byte) woolcolor);
        ...
        bed1.getWorld().getBlockAt(AXX, OYYY, TOZ).setData((byte) woolcolor);
        ...
        bed1.getWorld().getBlockAt(BXX, OYYY, BZZ).setData((byte) woolcolor);
        ...
        bed1.getWorld().getBlockAt(CXX, OYYY, CZZ).setData((byte) woolcolor);
        ...
        bed1.getWorld().getBlockAt(DXX, OYYY, CZZ).setData((byte) woolcolor);
        ...
        bed1.getWorld().getBlockAt(EXX, OYYY, EZZ).setData((byte) woolcolor);
        ...
        bed1.getWorld().getBlockAt(FXX, OYYY, FZZ).setData((byte) woolcolor);
        ...
        bed1.getWorld().getBlockAt(GXX, OYYY, GZZ).setData((byte) woolcolor);
        ...
        bed1.getWorld().getBlockAt(HXX, OYYY, HZZ).setData((byte) woolcolor);
        ...
        bed1.getWorld().getBlockAt(IXX, OYYY, HZZ).setData((byte) woolcolor);
        ...
        bed1.getWorld().getBlockAt(JXX, OYYY, JZZ).setData((byte) woolcolor);
        ...
        bed1.getWorld().getBlockAt(AX, PYYY, TOZ).setData((byte) woolcolor);
        ...
        bed1.getWorld().getBlockAt(TOX, NYYY, TOZ).setData((byte) woolcolor);
        ...
        bed1.getWorld().getBlockAt(FX, NYYY, TOZ).setData((byte) woolcolor);
